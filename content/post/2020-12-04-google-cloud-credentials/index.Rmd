...
summary: ''
authors: []
lastmod: '2020-12-04T13:41:48-05:00'
featured: no
image:
  placement: 1
  caption: ''
...
```{r eval = FALSE}
gs4_auth_configure(app = "/PATH/TO/THE/DOWNLOADED/OAUTH/JSON.json")
```
...
```{r eval = FALSE}
gs4_auth_configure(app = "/PATH/TO/THE/DOWNLOADED/SERVICE/ACCOUNT/JSON.json")
```
